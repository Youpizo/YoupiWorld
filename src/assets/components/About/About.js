...
const About = () => {
  return (
    <div className="about-page">
      <Collapse title="Fiabite" content="Les annonces postées sur Kasa garantissent une fiabilité totale. Les photos sont conformes aux logements et toutes les informations sont régulièrement vérifiées par nos équipes." />
